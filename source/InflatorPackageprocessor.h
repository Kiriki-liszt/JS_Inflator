...
#define M_PI        3.14159265358979323846264338327950288   /* pi             */
		...
		void proc_in(SampleType** inputs, Vst::Sample64** outputs, Steinberg::int32 numChannels, int32 sampleFrames);
		template <typename SampleType>
		void proc_out(Vst::Sample64** inputs, SampleType** outputs, Steinberg::int32 numChannels, int32 sampleFrames);
